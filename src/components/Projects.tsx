  ...
  const projects = [
    {
      ...
      situation: "Client needed a modern e-commerce solution to increase online sales.",
      task: "Design and develop a responsive e-commerce platform with secure payment integration.",
      action: "Led a team of 3 developers to build the platform using Next.js, TypeScript, and Stripe API.",
      result: "Increased client's online sales by 45% in the first quarter post-launch."
    },
    {
      title: "Healthcare Management System",
      situation: "Healthcare provider struggled with patient record management.",
      task: "Create an intuitive system for managing patient records and appointments.",
      action: "Developed a React-based application with secure authentication and real-time updates.",
